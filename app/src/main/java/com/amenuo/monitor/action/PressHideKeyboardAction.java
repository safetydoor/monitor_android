 ...
 */
public class PressHideKeyboardAction {
    /**
    ...
    public static void hideSoftInput(IBinder token) {
        if (token != null) {
            InputMethodManager im = (InputMethodManager) MonitorApplication.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
