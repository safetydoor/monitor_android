			...
			public void onClick(final View view) {
				...
				if (a != null && a.hasStarted() && !a.hasEnded()) {
					...
					if (type == ExpandCollapseAnimation.EXPAND) {
						 ...
						 * button.findViewById(com.
						 * handmark.pulltorefresh.library.R.id.arrow); Animation
						 * rotate = new
						 * RotateAnimation(0f,180f,Animation.RELATIVE_TO_SELF
						 * ,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
						 * rotate.setFillAfter(true); rotate.setDuration(380);
						 * arrow.startAnimation(rotate);
						 */
						openItems.set(position, true);
						if (ActionSlideExpandableListView.onItemClickListener != null) {
							ActionSlideExpandableListView.onItemClickListener
									.OnClick(position, 1);
						}
					...
					if (type == ExpandCollapseAnimation.EXPAND) {
						if (lastOpenPosition != -1
							...
							/*
							 * ImageView arrow = (ImageView)
							 * lastToggle.findViewById
							 * (com.handmark.pulltorefresh.library.R.id.arrow);
							 * Animation rotate = new
							 * RotateAnimation(180f,0f,Animation
							 * .RELATIVE_TO_SELF
							 * ,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
