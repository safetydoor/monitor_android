...
//					P2PHandler.getInstance().controlCamera(callId, password, MyUtils.aperture_big);
	...
	public void onClick(View v) {
		...
		if (id == R.id.video_mode_hd) {
		...
		} else if (id == R.id.steering_wheel) {
		...
		} else if (id == R.id.defence_state) {
			setDefence();
		} else if (id == R.id.choose_video_format) {
			changevideoformat();
		} else if (id == R.id.rl_lamp) {
			showProgress_lamp();
			if (lamp_switch != 0) {
			...
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.zoom_small);
		} else if (id == R.id.img_zoom_big) {
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.zoom_big);
		} else if (id == R.id.img_focus_small) {
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.focus_small);
		} else if (id == R.id.img_focus_big) {
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.focus_big);
		} else if (id == R.id.img_aperture_small) {
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.aperture_smal);
		} else if (id == R.id.img_aperture_big) {
			P2PHandler.getInstance().controlCamera(callId, password,
					Utils.aperture_big);
...
//		}
	...
	public void onStopTrackingTouch(SeekBar seekbar) {
		...
		if (id == R.id.seekbar_zoom) {
			...
			seekbar_focus.setProgress(5);
		} else if (id == R.id.seekbar_aperture) {
